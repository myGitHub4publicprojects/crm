...
param_source_db = "dbname=crm_db2 user=%s password=%s" % (postgres_user, postres_pass)
param_target_db = "dbname=crm_db2 user=%s password=%s" % (postgres_user, postres_pass)
