# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2018-02-27 04:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('activation_date', models.DateField(default=datetime.date(2018, 4, 28))),
            ],
        ),
        migrations.CreateModel(
            name='HA_Invoice',
        ...
        migrations.CreateModel(
            name='NFZ_Confirmed',
            fields=[
                ('nfz_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='crm.NFZ')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Patient')),
            ],
            bases=('crm.nfz',),
        ),
        ...
        migrations.AddField(
            model_name='reminder',
            name='ha',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.Hearing_Aid'),
        ),
        migrations.AddField(
            model_name='reminder',
            name='invoice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.HA_Invoice'),
        ),
        migrations.AddField(
            model_name='reminder',
            name='nfz',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='crm.NFZ_Confirmed'),
        ),
        migrations.AddField(
            model_name='reminder',
            name='pcpr',
